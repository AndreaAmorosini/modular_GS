...
if not envs_path.exists():
    st.sidebar.warning("Cartella '.envs' non trovata. Assicurati che esista nella root del progetto.")
...
if not methods_dir.exists():
    st.sidebar.warning("Cartella 'methods' non trovata automaticamente.")
    methods_dir_input = st.sidebar.text_input("Percorso cartella metodi", value=str(base_path / "methods"))
...
if not available_methods:
    st.warning("Nessun metodo trovato nella cartella 'methods'. Assicurati che ci siano sottocartelle con config.yaml o config.json.")
    st.stop()
...
if config:
    ...
    st.error("No valid configuration file found for the selected method. Please ensure there is a config.yaml or config.json in the method's directory.")
